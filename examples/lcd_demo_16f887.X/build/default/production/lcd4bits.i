...
void LCD_Initialize( uint8_t lines, uint8_t row ){
  ...
  _delay((unsigned long)((30u)*(20000000/4000.0)));

  lcd_PutNibble( 0x03u );
  do{ RE0 = 0; do{ RE1 = 1; _delay((unsigned long)((10)*(20000000/4000000.0))); RE1 = 0; }while(0);; } while(0);
  _delay((unsigned long)((100u)*(20000000/4000.0)));
  lcd_PutNibble( 0x03u );
  do{ RE0 = 0; do{ RE1 = 1; _delay((unsigned long)((10)*(20000000/4000000.0))); RE1 = 0; }while(0);; } while(0);
  _delay((unsigned long)((200u)*(20000000/4000000.0)));
  lcd_PutNibble( 0x03u );
  do{ RE0 = 0; do{ RE1 = 1; _delay((unsigned long)((10)*(20000000/4000000.0))); RE1 = 0; }while(0);; } while(0);
  _delay((unsigned long)((200u)*(20000000/4000000.0)));
  lcd_PutNibble( 0x02u );
  ...
  _delay((unsigned long)((50u)*(20000000/4000000.0)));
  ...
  _delay((unsigned long)((2u)*(20000000/4000.0)));
}


void LCD_PrintChar( char a ){
  do{ _delay((unsigned long)((1)*(20000000/4000.0))); }while(0);
 lcd_PutNibble( a>>4u );
  do{ RE0 = 1; do{ RE1 = 1; _delay((unsigned long)((10)*(20000000/4000000.0))); RE1 = 0; }while(0);; } while(0);
